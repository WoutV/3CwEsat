...
\end{figure}
 ...
 \begin{subfigure}{0.8\textwidth}
 \centering
 \includegraphics[width=\textwidth]{errorExp2.png}
 \subcaption{Nulpunten van $T_n$}
 \end{subfigure}
 
 \caption{Absolute fout bij het interpoleren van $\frac{1}{1+6x^2}$}
 \label{errpolexp}
 \end{figure}
 
 Als we de maximale fout in functie van de graad van de benadering uitzetten zien we ook dat bij hogere graad de equidistante punten weer onderdoen. We merken zelfs een stijging in de maximale fout vanaf een bepaald punt. De Chebychev interpolatie daarentegen daalt in het begin ongeveer even snel, maar blijft bij hogere graad constant rond $\epsilon_{mach}$. Dit wordt duidelijk op figuur \ref{maxerr}\\
 ...
 \begin{subfigure}{0.5\textwidth}
 \centering
 \includegraphics[width=\textwidth]{maxExp.png}
